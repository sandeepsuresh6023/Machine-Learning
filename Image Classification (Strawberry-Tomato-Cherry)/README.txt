'train.py' contains the algorithm for final model which was developed. The model is in model/model.h5.

'test.py' contains the code for testing the final model.
